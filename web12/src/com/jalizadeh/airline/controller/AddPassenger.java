...
public class AddPassenger extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("selected_gender", "Male");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(firstName.length() == 0) {
			...
			//web 12
			//form validation: if the input is empty, it will be set empty again
			request.setAttribute("first_name", "");
		} else {
			p.setFirstName(firstName);
			
			//web 12
			//form validation: if there is any problem with other fields, 
			//the firstname is filled with it`s inserted value
		...
		//web 12
		//I do it myself
		request.setAttribute("selected_gender", gender);
		
		//if there is any error, it must be shown and handled
